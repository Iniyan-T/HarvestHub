...
export function AIAssistant({ userId, userType }: AIAssistantProps) {
      ...
      <div className="flex items-center justify-between px-6 py-4 border-b border-gray-200 bg-gradient-to-r from-emerald-50 to-blue-50">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-gray-600">Powered by Ollama AI</p>
          </div>
        </div>
        {messages.length > 0 && (
          <button
      ...
      <div className="flex-1 overflow-y-auto p-6 space-y-4">
        {messages.length === 0 ? (
          <div className="text-center py-12">
            ...
            <p className="text-sm text-gray-600 mb-6">Ask me anything about your crops, inventory, or market insights</p>
